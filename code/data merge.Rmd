...
covid
victims
sum(victims$Territorial.Authority == "Hamilton City.")
```
...
```{r}
covid <- covid %>% rename(number_of_victimizations = No)

total <- rbind(victims, covid)


write.csv(total,"/Users/keirynhart/Documents/Uni/Data 301/DATA301-Group-Project/Data/merged data (round 2).csv")
```
